const startScanButton = document.getElementById("start-scan8");
const stopScanButton = document.getElementById("stop-scan8");
const inputCodigo = document.getElementById("filtroInput");
